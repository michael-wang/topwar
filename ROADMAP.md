...
- A giant Boss replaces one row eight rows before each next-tier saturation. Tier-1 Boss is row 136 with 13,500 HP; later Boss HP uses 1000 times its normal tier power. Enemy and reward streams continue behind Bosses.
...
**Formula-driven infinite progression validation and balance cleanup.** Playtest sustained handoffs, compact squads, reward acquisition, and the unbounded tier loop.

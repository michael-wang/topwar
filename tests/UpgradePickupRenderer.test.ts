...
describe('UpgradePickupRenderer', () => {
  it('reuses visible plaques, removes departed ones, and disposes shared resources', () => {
    ...
    renderer.update([{ id: 1, x: -2.7, z: 8, rewardAmount: 1, rewardKind: 'rifle' }]);
    ...
    renderer.update([{ id: 1, x: -2.7, z: 4, rewardAmount: 1, rewardKind: 'rifle' },
      { id: 2, x: 2.7, z: 8, rewardAmount: 1, rewardKind: 'tier2Rifle' }]);
    ...
    renderer.update([{ id: 2, x: 2.7, z: 6, rewardAmount: 1, rewardKind: 'tier2Rifle' }]);
